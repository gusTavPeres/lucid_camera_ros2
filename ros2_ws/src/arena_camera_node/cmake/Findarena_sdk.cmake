...
if(EXISTS ${_arena_sdk_conf})
	...
	elseif("${ArenaSDK_Build}" STREQUAL "Linux64_x64_54")
		...
		## OpenCV from ArenaSDK (required for libarena.so)
		${arena_sdk_installation_root}/OpenCV/lib/libopencv_core.so
		${arena_sdk_installation_root}/OpenCV/lib/libopencv_calib3d.so
		${arena_sdk_installation_root}/OpenCV/lib/libopencv_imgproc.so
		${arena_sdk_installation_root}/OpenCV/lib/libopencv_features2d.so
		${arena_sdk_installation_root}/OpenCV/lib/libopencv_flann.so
